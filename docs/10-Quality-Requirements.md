...
| CC-11 | The workspace projection renders and drives a running holospace                      | the [Dev Container](https://containers.dev) reference experience and the editor/terminal surface (file content, terminal I/O)                                                                                                                                                                                                                                                  | the editor and file tree read the environment’s content by κ; the operator’s edits and terminal commands publish as canonical events on the holospace’s channels and advance its κ snapshot                                                                                                                                                                                                                                                                         | witness `vv/suites/cc11-workspace` (the workspace projection; status reported by the V&V) |
