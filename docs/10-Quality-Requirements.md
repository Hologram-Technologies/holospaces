...
| CC-7  | The κ-disk preserves a real filesystem                                               | a real on-disk filesystem image (the [Linux](https://www.kernel.org) `ext4` / FAT format)                                                                                                                                                                                                                                                                                      | bytes written through the `KappaStore`-backed block device read back byte-identically; the disk image’s κ is reproducible                                                                                                                                                                                                                                                                                                                                           | live (`vv/suites/cc7-kdisk`)             |
