...
#   authorities, run against the AArch64 *and* x86-64 cores' own virtio-mmio
#   transports (the third core, RISC-V, is the extraction's origin).
# Witness: crates/holospaces/tests/cc46_devbus_parity.rs — each of the aarch64
#   and x86-64 cores mounts a 9p export and shares files, NATs an outbound TCP
#   flow, and exposes the in-process guest bridge, all through the shared devbus.
#
